...
const CITY_COORDS: Record<string, [number, number]> = {
  ...
  locarno: [46.1704, 8.7986],
  medinah: [41.9464, -88.0451],
  ...
  'pebble beach': [36.5686, -121.9506],
  'rio de janeiro': [-22.9068, -43.1729],
  siena: [43.3188, 11.3308],
  sotogrande: [36.2882, -5.2789],
  'st andrews': [56.3398, -2.7967],
  telluride: [37.9375, -107.8123],
  tokushima: [34.0703, 134.5549],
};
